...
3. Write the answer with an inline `[[slug]]` citation on every claim. When the answer describes current state, name the `dated` of the newest source it rests on.
